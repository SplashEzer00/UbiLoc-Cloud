  ...
  <div class="app-container home">
    ...
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        ...
        <p>
          UbiLoc穿戴式三维动作捕捉与分析系统管理系统，它基于若依框架开发，可以用于的Web网站管理后台应用程序。所有前端后台代码封装过后十分精简易上手，出错概率低。
        </p>
        <p>
    ...
    <el-row :gutter="20">
      <el-col :xs="24" :sm="24" :md="12" :lg="8">
        <el-card class="update-log">
          ...
          <div class="body">
            <p>
              <i class="el-icon-s-promotion"></i> 管理系统网址：<el-link
                href="http://localhost/index"
                target="_blank"
                >http://localhost/index</el-link
              >
            </p>
            <p>
            ...
            <p>
              <i class="el-icon-chat-dot-round"></i> 指导老师：<a
                href="javascript:;"
                >中国地质大学（武汉）尚建嘎 476206397</a
              >
            </p>
            <p>
              <i class="el-icon-money"></i> 开发人员：<a
                href="javascript:;"
                class="支付宝信息"
                >中国地质大学（武汉）李炜仁</a
              >
      ...
      <el-col :xs="24" :sm="24" :md="12" :lg="8">
        <el-card class="update-log">
          ...
          <div class="body">
            <img
              src="../assets/images/payforme.jpg"
              alt="donate"
              width="100%"
            />
